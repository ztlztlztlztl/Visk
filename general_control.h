...
public:
    ...
    // exponent: 1.0=线性 0.35=推荐 0.0=等分
    // floorRatio: 0.0=不保底 0.01=推荐（每个文件至少分到 max 的 1%）
    std::vector<TreemapItem> get_treemap(const QString& drive_letter, uint32_t target_index,
